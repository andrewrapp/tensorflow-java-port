...
public class TensorFlowInferenceInterface {
    ...
    public TensorFlowInferenceInterface(byte[] modelFile) {
...
//                runStats.add(r.metadata);
    ...
    public Operation graphOperation(String operationName) {
        ...
        if (operation == null) {
            throw new RuntimeException(
                    "Node '" + operationName + "' does not exist in model");
        }
        return operation;
    }
    ...
    private void loadGraph(byte[] graphDef) throws IOException {
...
//                "Model load took " + (endMs - startMs) + "ms, TensorFlow version: " + TensorFlow.version());
    ...
    static class RunStats {
        ...
        // up as.
        static byte[] fullTraceRunOptions = new byte[] {0x08, 0x03};
    }
}
